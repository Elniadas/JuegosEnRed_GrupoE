class Tutorial extends Phaser.Scene {
    ...
    create() {
        ...
        this.tutorial = this.add.sprite(this.game.canvas.width / 2, this.game.canvas.height / 4, 'Tutorial');
        this.tutorial.play('Tutorial');
        this.tutorial.displayHeight = this.tutorial.height * 0.55
        this.tutorial.displayWidth = this.tutorial.width * 0.55
